...
# skip if no /swiftlint autocorrect
echo "Checking if comment contains '/swiftlint autocorrect' command..."
(jq -r ".comment.body" "$GITHUB_EVENT_PATH" | grep -Fq "/swiftlint autocorrect") || exit $NEUTRAL_EXIT_CODE
